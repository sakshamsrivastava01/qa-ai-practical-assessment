...
- Name: api\auth.spec.js >> API AC1 - Authentication & Cart Creation @api >> TC-API-03 valid credentials return a bearer token @smoke @regression
- Location: tests\api\auth.spec.js:22:3
