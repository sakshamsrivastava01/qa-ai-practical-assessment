...
- Name: api\auth.spec.js >> API AC1 - Authentication & Cart Creation @api >> TC-API-04 login is rejected for invalid credentials @smoke @regression
- Location: tests\api\auth.spec.js:34:3
