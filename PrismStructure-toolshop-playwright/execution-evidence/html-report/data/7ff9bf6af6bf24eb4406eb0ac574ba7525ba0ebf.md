...
- Name: api\cart-invoice.spec.js >> API AC2 - Product Selection & Invoice Generation @api >> TC-API-08 user can add a product to the cart and verify contents @smoke @regression
- Location: tests\api\cart-invoice.spec.js:38:3
